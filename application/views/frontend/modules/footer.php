<footer id="footer">
        ...
        <div class="container">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <ul class="list-unstyled social pull-right">
                  <li><a href="https://www.facebook.com/hungg.qb/"><i class="fab fa-facebook-f"></i></a></li>
                  <li><a href="https://twitter.com/ngHng28571569"><i class="fab fa-twitter"></i></a></li>
                  <li><a href="#"><i class="fab fa-google-plus-g"></i></a></li>
                  <li><a href="https://www.youtube.com/channel/ UCOyVd0BgSD5ChRJjdmcqf6w?view_as=subscriber"><i class="fab fa-youtube"></i></a></li>
              </ul>
          </div>
      </div>
  </div>
  <div class="top-footer">
    <div class="container">
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="col-xs-12 col-sm-6">
                <a href="trang-chu">
                    <img src="public/images/smart-mobi2.png" style="width: 90%;" class="img-fix f-logo" alt="smart-construction">
                </a>
                <div class="about-store">
            Công ty CP Đầu tư Organica - Phát triển và phân phối thực phẩm hữu cơ cho người Việt
             </div>
         </div>
         <div class="col-xs-12 col-sm-6">
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    <li class="clearfix">
                        ...
                        <span>40 Đồng Xoài, Hòa Minh, Liên Chiểu</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-phone"></i>
                        <span>0762.773.779</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-envelope"></i>
                        <span><a href="mailto:tranvanhai@gmail.com">tranvanhai@gmail.com</a></span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
        <div class="col-xs-12 col-sm-6">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3834.2298250987656!2d108.1659717!3d16.0535593!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3142193d8dbaa16f%3A0xe51666b1e91c6dd8!2zNDAgxJDhu5NuZyBYb8OgaSwgSG_DoCBNaW5oLCBMacOqbiBDaGnhu4N1LCDEkMOgIE7hurVuZyA1NTAwMDA!5e0!3m2!1svi!2s!4v1698718478747!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        ...
        <div class="contact-title">
          <div class="contact-text-wrapper">
            ...
            <div class="text-center">
              <div><a href="tel:0762773779" rel="nofollow">0762773779 <b>(Mr. Hai)</b></a><span> | </span><a href="tel:037.899.1033" rel="nofollow">037.899.1033 <b>(Mr. Dũng)</b></a></div>
              <div><span>Email: tranvanhai@gmail.com</span></div>
            </div>
          </div>
        </div>
        <div class="contact-set flex text-center">
          <div class="w-50">
            <a href="http://zalo.me/0762773779" rel="noopener nofollow" target="_blank" title="Chat Zalo">
              <div class="flex-center"><span class="flex has-icon zalo-icon"></span></div>
              <div>
                <h4>Chat Zalo</h4>
                <p>Chat trực tuyến với nhân viên Organica </p>
              </div>
            </a>
          </div>
          <div></div>
          <div class="w-50">
            <a href="https://www.messenger.com/t/tranvanhai" title="Liên hệ">
              <div class="flex-center"><span class="has-icon contact-icon"></span></div>
              <div>
                <h4>Gửi yêu cầu</h4>
                <p>Organica sẽ phản hồi ngay khi nhận được yêu cầu</p>
              </div>
            </a>
          </div>
        </div>
