					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
								...
								<div id="km-detail">
									...
									<div class="fk-main">
										<div class="fk-sales">
											...
											<ul>
												<li>Mua từ 5 mặt hàng tổng giá trị 1.000.000đ sẽ được tặng mã giảm giá 50.000đ <br/> <a href="https://www.facebook.com/hungg.qb" target="_blank">Liên hệ</a>
												</li>
											</ul>
										</div>
									</div>
							...
							<div style="margin-top: 20px;">
								<b>ĐẶC TÍNH</b>
								<br>
								<span>Chứng nhận hữu cơ EU, Không hóa chất, Không chất bảo quản</span>
							</div>
							<div style="margin-top: 20px;">
								<b>CHẤT LƯỢNG</b>
								<br>
								<span>Organica có trang trại rau nhiệt đới đầu tiên tại Việt Nam đạt chứng nhận hữu cơ của Bộ Nông nghiệp Mỹ (USDA) & EU Organic Farming (Liên minh châu Âu)</a>
							</div>
						</div>
					</div>
